...
}; // প্রথমে Doubly Linked List এর একটি Node class বানিয়ে নিলাম যাতে করে Doubly Linked List তৈরি করতে পারি
...
{
public:
    // Queue তৈরির জন্য একটি Doubly Linked List এর Head এবং Tail ইনিশিয়ালাইজ করে নিচ্ছি
    Node *head = NULL;
    Node *tail = NULL;
    ...
    void pop() // Queue এর শুরু থেকে অর্থাৎ লাইনে যে ভ্যালু সবার আগে আছে তা Queue থেকে রিমুভ করার জন্য একটি ফাংশন তৈরি করা হলো
    {
        ...
        // নিচে Doubly Linked List এর প্রথম ভ্যালু অর্থাৎ Head ডিলিট করার কোড দেয়া আছে যার কমপ্লেক্সিটি O(1)
